...
#   c) node1 mines 32 blocks, so now node 0 has 60001book, node 1 has 4250book, node2 has none.
#   d) node0 sends 601 book to node2, in two transactions (301 book, then 300 book).
