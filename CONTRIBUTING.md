Contributing to ViBOOK Core
============================

The ViBOOK Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ViBOOK Core project, and is not to be
confused with overall ViBOOK Network Protocol consensus changes.

Whether a pull request is merged into ViBOOK Core rests with the project merge
...
Patches that change ViBOOK consensus rules are considerably more involved than
...
Where a patch set proposes to change the ViBOOK consensus, it must have been
...
The project leader is the release manager for each ViBOOK Core release.
