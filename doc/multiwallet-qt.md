...
In order to support loading of multiple wallets in vibook-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vibook.cpp.
...
Changes to vibook.cpp
----------------------
vibook.cpp is the entry point into vibook-qt, and as such, will require some minor modifications to provide hooks for
