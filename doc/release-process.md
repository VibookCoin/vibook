...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/eastcoastcrypto/vibook-detached-sigs.git
...
### Build and sign ViBOOK Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit vibook=v${VERSION} ../vibook/contrib/gitian-descriptors/gitian-win.yml
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import vibook/contrib/gitian-keys/*.gpg
    gpg --refresh-keys
...
- Detached signatures will then be committed to the [vibook-detached-sigs](https://github.com/eastcoastcrypto/vibook-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the vibookcoin.com server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/eastcoastcrypto/ViBOOK/releases/new) with a link to the archived release notes.
