...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ViBOOK features */
        {"vibook", "masternode", &masternode, true, true, false},
        {"vibook", "listmasternodes", &listmasternodes, true, true, false},
        {"vibook", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vibook", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vibook", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vibook", "masternodedebug", &masternodedebug, true, true, false},
        {"vibook", "startmasternode", &startmasternode, true, true, false},
        {"vibook", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vibook", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vibook", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vibook", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vibook", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vibook", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vibook", "mnbudget", &mnbudget, true, true, false},
        {"vibook", "preparebudget", &preparebudget, true, true, false},
        {"vibook", "submitbudget", &submitbudget, true, true, false},
        {"vibook", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vibook", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vibook", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vibook", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vibook", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vibook", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vibook", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vibook", "checkbudgets", &checkbudgets, true, true, false},
        {"vibook", "mnsync", &mnsync, true, true, false},
        {"vibook", "spork", &spork, true, true, false},
        {"vibook", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"vibook", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vibookd, or the -server option to vibook-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vibook-cli " + methodname + " " + args + "\n";
}
