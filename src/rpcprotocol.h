...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! ViBOOK is not connected
    ...
    RPC_WALLET_PASSVIBOOKASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
