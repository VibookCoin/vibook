...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ViBOOK Core vibook-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vibook-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vibook transaction") + "\n" +
                               "  vibook-tx [options] -create [commands]   " + _("Create hex-encoded vibook transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vibook transaction
