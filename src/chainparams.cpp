...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000a1ee89551c6534d76863eae83030a71fa6d8192f131cd54887bed25aa28"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1544850073, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("042e15b9f43adffcbb652f7184b5fbd2df90b60d156454c000a7d685f6cd81618cdfa32765b1f7569f8912e074f0f9cded301ed6458656138ee616d93617c34a48");
        nDefaultPort = 22260;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 ViBOOK starting difficulty is 1 / 2^12
        ...
        nZerocoinStartTime = 1644850073;
        nBlockEnforceSerialRange = 1; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = ~1; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = ~1; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = ~1; //Last valid accumulator checkpoint
        const char* pszTimestamp = "The secret of your success is determined by your daily agenda.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("044fb6d7a4b54f368e45858bbf559f6f441ef88753c546177bba939d450b50206b421e6880768ca1b7231e482f1f55f1dfc0eddf6cbba6e51211b4479e60ee34a8") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1544850073;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 522319;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000a1ee89551c6534d76863eae83030a71fa6d8192f131cd54887bed25aa28"));
        assert(genesis.hashMerkleRoot == uint256("0x9b159b08d1a0afa7482efd76887af5c8fca06dee9fc1eec107393a0bec19635a"));

	vSeeds.push_back(CDNSSeedData("43.224.33.202", "43.224.33.202"));
        vSeeds.push_back(CDNSSeedData("198.13.49.2", "198.13.49.2"));
        vSeeds.push_back(CDNSSeedData("108.160.130.126", "108.160.130.126"));
	...
	strSporkKey = "04A89A821386130BCA7C108B43D9C57C562C6CB625EF912F5787381188E76547D5CE28FA2A2B6CD9D563D2C00B57F9A4329384CA63AC0C10234E43AE4D102F8FC9";
        strObfuscationPoolDummyAddress = "VCpJVMF5kCGCbeEArTvs492KsRNxhcy2uF";
        nStartMasternodePayments = 1544850073;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // ViBOOK: 1 day
        nTargetSpacing = 1 * 60;  // ViBOOK: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet vibook addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet vibook script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet vibook BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet vibook BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet vibook BIP44 coin type is '1' (All coin's testnet default)
