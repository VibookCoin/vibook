...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 VIBOOK at the same time
...
enum ZerocoinSpendStatus {
    ZVIBOOK_SPEND_OKAY = 0,                            // No error
    ZVIBOOK_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZVIBOOK_WALLET_LOCKED = 2,                         // Wallet was locked
    ZVIBOOK_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZVIBOOK_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZVIBOOK_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZVIBOOK_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZVIBOOK_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZVIBOOK_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZVIBOOK_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZVIBOOK_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZVIBOOK_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZVIBOOK_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZVIBOOK_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZVIBOOK_SPENT_USED_ZVIBOOK = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZViBOOKAutoBackups(bool fEnabled)
    {
