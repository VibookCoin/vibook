...
/** Utility functions used by the ViBOOK Qt UI.
 */
namespace GUIUtil
{
...
// Render ViBOOK addresses in monospace font
...
// Parse "vibook:" URI into recipient object, return true on successful parsing
