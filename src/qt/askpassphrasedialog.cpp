                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zBOOK || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending BOOK because you wouldn't check it anyway.
    if (context == Context::Send_BOOK || context == Context::Send_zBOOK) {
