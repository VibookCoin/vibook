                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ViBOOK Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ViBOOK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vibook: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ViBOOK Core"), this);
    aboutAction->setStatusTip(tr("Show information about ViBOOK Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ViBOOK"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ViBOOK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ViBOOK addresses"));
    ...
    openAction->setStatusTip(tr("Open a ViBOOK: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ViBOOK Core help message to get a list with possible ViBOOK command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ViBOOK network", "", count));
}
...
{
    QString strTitle = tr("ViBOOK Core"); // default title
