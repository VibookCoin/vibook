...
QT_MOC_LITERAL(6, 86, 28), // "anonymizeViBOOKAmountChanged"
QT_MOC_LITERAL(7, 115, 26) // "coinControlFeaturesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "zeromintPercentageChanged\0"
    "preferredDenomChanged\0"
    "anonymizeViBOOKAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->anonymizeViBOOKAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::anonymizeViBOOKAmountChanged)) {
                *result = 3;
            }
        }
        {
...
// SIGNAL 3
void OptionsModel::anonymizeViBOOKAmountChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
