...
RESOURCES += src/qt/vibook.qrc src/qt/vibook_locale.qrc

TRANSLATIONS += src/qt/locale/vibook_bg.ts \
                src/qt/locale/vibook_de.ts \
                src/qt/locale/vibook_en.ts \
                src/qt/locale/vibook_es.ts \
                src/qt/locale/vibook_fi.ts \
                src/qt/locale/vibook_fr.ts \
                src/qt/locale/vibook_it.ts \
                src/qt/locale/vibook_ja.ts \
                src/qt/locale/vibook_pl.ts \
                src/qt/locale/vibook_pt.ts \
                src/qt/locale/vibook_ru.ts \
                src/qt/locale/vibook_sk.ts \
                src/qt/locale/vibook_sv.ts \
                src/qt/locale/vibook_vi.ts \
                src/qt/locale/vibook_zh_CN.ts \
                src/qt/locale/vibook_zh_TW.ts
